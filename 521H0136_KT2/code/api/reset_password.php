...
if (
    ...
    if (empty($email)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $sql = "UPDATE account SET password = '$hashed_password' WHERE email = '$email'";
                ...
                <div class="col-md-6 col-lg-5">
                    ...
                    <form novalidate method="post" action="" class="border rounded w-100 mb-5 mx-auto px-3 pt-3 bg-light">
                        <div class="form-group">
                            ...
                            <input readonly value="<?php echo $_GET['email'] ?>" name="email" id="email" type="text" class="form-control" placeholder="Email address">
                        </div>
                        <div class="form-group">
